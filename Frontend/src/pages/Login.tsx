  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl border border-gray-100">
        ...
        <h2 className="mb-8 text-3xl font-extrabold text-gray-900 text-center tracking-tight">Welcome Back</h2>
        ...
        <p className="mt-8 text-center text-gray-500 font-medium">
          Don't have an account? <Link to="/signup" className="text-black hover:text-gray-700 font-bold ml-1 transition-colors hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
